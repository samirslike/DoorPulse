...
const CONFIG_FILE =
    ...
    'C:\\ProgramData\\DoorPulse\\config.json';

const TOKEN_FILE =
    process.env.DOORPULSE_TOKEN_FILE ||
    'C:\\ProgramData\\DoorPulse\\refresh-token.txt';

const FTP_PASSWORD_FILE =
    process.env.DOORPULSE_FTP_PASSWORD_FILE ||
    'C:\\ProgramData\\DoorPulse\\ftp-password.txt';
...
const RECORDING_DIR =
    config.recordingDirectory || 'C:\\RingRecordings';

const FFMPEG_EXE =
    config.ffmpegPath || 'C:\\ffmpeg\\bin\\ffmpeg.exe';
